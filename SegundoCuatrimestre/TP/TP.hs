...
pixelsDiferentesEnFrame ((p1:[]):[]) ((p2:[]):[]) umbral = (0, 0, (diferenciaEntrePixels p1 p2)) : []
pixelsDiferentesEnFrame ((p1:p1s):[]) ((p2:p2s):[]) umbral = (0, 0, (diferenciaEntrePixels p1 p2)) : (pixelsDiferentesEnFrame (p1s:[]) (p2s:[]) umbral)
--pixelsDiferentesEnFrame (x:xs) (y:ys) umbral = (0, 0, (diferenciaEntrePixels p1 p2)) : (pixelsDiferentesEnFrame (p1s:[]) (p2s:[]) umbral)

-- *Main> pixelsDiferentesEnFrame v1f1 v2f2 1
-- [(0,0,(3,3,3)),(0,1,(3,3,3)),(1,0,(3,3,3)),(1,2,(-3,-3,-3)),(2,1,(-3,-3,-3)),(2,2,(-3,-3,-3))]

cosa :: Frame -> Frame -> (Integer, Integer) -> FrameComprimido
cosa ((p1:[]):[]) ((p2:[]):[]) (x, y)   = (x, y, (diferenciaEntrePixels p1 p2)) : []
cosa ((p1:p1s):[]) ((p2:p2s):[]) (x, y) = (x, y, (diferenciaEntrePixels p1 p2)) : (cosa (p1s:[]) (p2s:[]) (x + 1, y))
cosa ((p1:p1s):xs) ((p2:p2s):ys) (x, y) = (x, y, (diferenciaEntrePixels p1 p2)) : (cosa (p1s:xs) (p2s:[]) (x + 1, y)) : (cosa (p1s:[]) (p2s:ys) (x, y + 1))

diferenciaEntreFrames :: Frame -> Frame -> Frame
diferenciaEntreFrames (fr1:[]) (fr2:[]) = (diferenciaEntreArrayPixels fr1 fr2) : []
diferenciaEntreFrames (fr1:fr1s) (fr2:[]:fr2s) = (diferenciaEntreArrayPixels fr1 fr2) : (diferenciaEntreFrames fr1s fr2s)

diferenciaEntreArrayPixels :: [Pixel] -> [Pixel] -> [Pixel]
diferenciaEntreArrayPixels (p1:[]) (p2:[])    = (diferenciaEntrePixels p1 p2) : []
diferenciaEntreArrayPixels (p1:p1s) (p2:p2s)  = (diferenciaEntrePixels p1 p2) : (diferenciaEntreArrayPixels p1s p2s)

diferenciaEntrePixels :: Pixel -> Pixel -> Pixel
diferenciaEntrePixels (x1, y1, z1) (x2, y2, z2) = (x1-x2, y1-y2, z1-z2)
